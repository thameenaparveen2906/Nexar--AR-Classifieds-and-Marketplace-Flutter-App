...
class ToysAndGamesPage extends StatefulWidget {
  const ToysAndGamesPage({super.key});
  @override
  _ToysAndGamesPageState createState() => _ToysAndGamesPageState();
}

class _ToysAndGamesPageState extends State<ToysAndGamesPage> {
  ...
  final List<String> _toysAndGamesCategories = [
    'Action Figures',
    'Board Games',
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: _toysAndGamesCategories.map((String category) {
