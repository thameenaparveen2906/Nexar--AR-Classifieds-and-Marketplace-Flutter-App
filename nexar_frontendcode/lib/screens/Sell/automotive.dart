...
class AutomotivePage extends StatefulWidget {
  const AutomotivePage({super.key});
  @override
  _AutomotivePageState createState() => _AutomotivePageState();
}
...
class _AutomotivePageState extends State<AutomotivePage> {
  ...
  final List<String> _automotiveCategories = [
    'Car',
    'Motorcycle',
    'Bicycle',
    'Car Accessories',
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: _automotiveCategories.map((String category) {
